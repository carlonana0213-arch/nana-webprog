...
function ArticlePage() {
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      <section className="border-y-2 border-zinc-900 bg-blue-950 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="max-w-3xl">
          <div className="mb-4">
      ...
      <section className="border-y-2 border-zinc-900 bg-zinc-50 px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
        <div className="mx-auto max-w-6xl grid gap-8 lg:grid-cols-2">
          {" "}
          <div className="mb-6 overflow-hidden rounded-[1.25rem] border-2 border-zinc-900">
            <img
              src={article.image}
              alt={article.title}
